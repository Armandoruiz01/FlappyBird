...
public class Game extends JPanel implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        if (isRunning) {
            ...
            g2.drawString("Puntaje: " + this.tubeColumn.getPoints(), 10, 20);
            ///////////////////////////////
        } else {
            g2.setColor(Color.black);
            g.setFont(new Font("Arial", 1, 20));
            g2.drawString("Presiona Enter para iniciar", Window.WIDTH / 2 - 150, Window.HEIGHT / 2);
            g2.setColor(Color.black);
            g.setFont(new Font("Arial", 1, 15));
            g2.drawString("Hecho por: Luis Y Jimena ", Window.WIDTH - 250, Window.HEIGHT - 50);
        }
        g2.setColor(Color.black);
        g.setFont(new Font("Arial", 1, 20));
        g2.drawString("Record: " + highScore, Window.WIDTH - 160, 20);
